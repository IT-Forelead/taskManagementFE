...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
        <defs>
            <path id="solarWalletMoneyOutline0" fill="currentColor" d="M19 14a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"></path>
        </defs>
        ...
        clipRule="evenodd"></path>
    <path fill="currentColor" d="M6 9.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5H6Z"></path>
    <use href="#solarWalletMoneyOutline0" fillRule="evenodd" clipRule="evenodd"></use>
</svg></template>
  
<script>
export default {
    name: 'SolarWalletMoneyOutline'
}
</script>