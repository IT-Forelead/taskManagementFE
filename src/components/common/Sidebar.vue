...
<template>
    <div v-if="useSidebarStore().toggleSidebar">
        <div class="fixed inset-0 bg-slate-900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200"
            :class="useSidebarStore().isOpenSidebar ? 'opacity-100' : 'opacity-0 pointer-events-none'"
        ...
        <div id="sidebar" ref="sidebar"
            ...
            <div class="flex justify-between mb-10 pr-3 sm:px-2">
                <button class="lg:hidden text-slate-500 mt-12 hover:text-slate-400"
                    @click="useSidebarStore().toggleSidebar">
            ...
            <div class="space-y-8">
                <div class="mt-6 text-gray-400">
                    <router-link v-if="!isMediumScreen" to="/add-task" active-class="active"
